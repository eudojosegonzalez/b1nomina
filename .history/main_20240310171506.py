...
from routers.campos_adicionales_user import campos_user_router
...
tags_metadata = [
    ...
    {
        "name": "Campos Adicionales Usuarios",
        "description": "Operaciones relacionadas con los Campos Adicionales de los Usuarios",
    },                
    {
...
app.include_router(campos_user_router)
