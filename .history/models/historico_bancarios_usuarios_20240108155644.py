...
from sqlalchemy import Column, Integer, String, Float, VARCHAR, BIGINT,INTEGER, DATE, DateTime, Boolean, ForeignKey, BOOLEAN,TEXT
...
class HistoricoBancariosUser(Base):
    ...
    banco_id = Column(BIGINT,  ForeignKey("Bancos.id", ondelete="RESTRICT", onupdate="CASCADE"))
