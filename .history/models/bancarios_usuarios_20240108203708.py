...
from sqlalchemy import Column, Integer, String, Float, VARCHAR, BIGINT,INTEGER, DATE, DateTime, Boolean, ForeignKey, BOOLEAN
...
class BancariosUser(Base):
    ...
    banco_id = Column(BIGINT,  ForeignKey("Banco.id", ondelete="RESTRICT", onupdate="CASCADE"), nullable=False)
