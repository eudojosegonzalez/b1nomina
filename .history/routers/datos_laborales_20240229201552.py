...
def create_datos_laborales(datosLaborales:DatosLaboralesSchema, userCreatorId : int = Query (ge=1, le=os.getenv("MAX_ID_USERS")))->dict:
    ...
    if (estado=="1"):
        ...
        datoLaboral=result['dat0']
        return JSONResponse (status_code=521,content={"message":"Este usuario ya tiene Datos Laborales no puede volver a crearlo","Dato Laboral":jsonable_encoder(datoLaboral)})     
