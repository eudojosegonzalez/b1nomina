...
@dashboard_admin_router.get ('/dashboard_admin_home/resumen_empleados',
tags=["DashboardAdmin"],
dependencies=[Depends(JWTBearer())],
responses=
    { 
...
def get_resumen_empleados():
    ...
    if (result):
        if (result["result"]=="1"):
            ...
            return JSONResponse(status_code=520,content={"message":"Este usuario no tiene modulos asignados"})     
    
    
    return JSONResponse(status_code=521,content={"message":"Este usuario no tiene modulos asignados"})   
