...
# ruta para listar las departamentos en el sistema
@departamentos_router.get ('/list_departamento', 
tags=["Departamentos"],
dependencies=[Depends(JWTBearer())],
responses=
    { 
...
def list_departamento(page : int = 1, records : int = 20)->dict:
    db = Session()
    # almacenamos el listado de usarios en un resultset
    result = departamentosController(db).list_departamentos(page,records)
...
def list_departamento_sociedad(idSociedad: int, page : int = 1, records : int = 20)->dict:
    db = Session()
    # almacenamos el listado de usarios en un resultset
    result = departamentosController(db).list_departamentos_sociedad(idSociedad,page,records)
