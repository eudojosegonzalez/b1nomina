                            ...
                            "example":
                                {
                                    ...
                                    "data": "{'id': '1','tramo':'Tramo 1','desde': '0','hasta': '13.5','valor_carga':0,'created':'2024-02-26T10:00:00','updated': '2024-02-26T10:00:00','creator_user': '1','updater_user': '1'}",
                                }
                        } 
...
def update_tramo_asignacion_familiar(tramosAsignacionFamiliar:TramosAsignacionFamiliarSchema, user_updater: int = Query(ge=1, le=os.getenv('MAX_ID_USERS')), id : int = Path(ge=1,le=1000))->dict:
    ...
    result = TramoAsignacionFamiliarController(db).update_tramo_asignacion_familiar(tramosImpuestoUnico, user_updater, id) 
    if (result['result']=="1"):
        data=result['data']
