...
@user_localization_router.post ('/create_user_contact', tags=["Localizacion"],status_code=200, dependencies=[Depends(JWTBearer())])
...
@user_localization_router.get ('/user_contact', tags=["Localizacion"],status_code=200, dependencies=[Depends(JWTBearer())])
...
@user_localization_router.get ('/user_contact/{id}', tags=["Localizacion"],status_code=200, dependencies=[Depends(JWTBearer())])
...
@user_localization_router.put ('/user_contact/{id}/update', tags=["Localizacion"],status_code=200, dependencies=[Depends(JWTBearer())])
