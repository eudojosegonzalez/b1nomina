...
def create_user_ubicacion(userCreatorId:int,ubicacionUserSchema:UbicacionUserSchema)->dict:
    ...
    if (estado=="1") :
        ...
        return JSONResponse (status_code=501,content={"message":"Ya existen los datos de ubicación de este usuario, no puede volver a crearlos","ubicationUserId":result})    
    else:
        return JSONResponse (status_code=502,content={"message":"Ocurrió un error que no pudo ser controlado","estado":result})              
...
def get_user_ubication(id: int)->dict:
    ...
    if (estado=="1") :
        ...
        return JSONResponse (status_code=501,content={"message":"Ocurrió un error que no pudo ser controlado","estado":estado}) 
