                    ...
                    "example":
                        {
                            ...
                            "contactUser":"{\n'id': 1,\n'user_id': 100,'email': 'example@micorreo.com','fijo': '226656168','movil' : '939024766','created':'2023-12-01 09:00:01','updated':'2023-12-10 19:00:01','creator_user':'1','updater_user':'10'}"
                        }
                    } 
                }       
            },
...
def update_user_contact(userUpdaterId:int,contactUserSchema:ContactUserSchema)->dict:
    ...
    if (estado=="1") :
        ...
        return JSONResponse (status_code=201,content={"message":"Se actualizó el contacto del usuario en el sistema","contactUser":contactUser})     
    elif (estado=="-2"):
        return JSONResponse (status_code=500,content={"message":"No se consiguieron los datos de contacto del usuario","estado":result}) 
    else:     
        return JSONResponse (status_code=501,content={"message":"Ocurrió un error que no pudo ser controlado","estado":result})     
