...
@grupos_empleados_router.get ('/sociedad/{id}', 
tags=["Sociedades"],
#dependencies=[Depends(JWTBearer())],
responses=
    { 
...
@grupos_empleados_router.get ('/sociedad/{id}/list_sede', 
tags=["Sociedades"],
#dependencies=[Depends(JWTBearer())],
responses=
    { 
...
@grupos_empleados_router.get ('/sociedad/{id}/list_departamentos', 
tags=["Sociedades"],
#dependencies=[Depends(JWTBearer())],
responses=
    { 
...
@grupos_empleados_router.get ('/sociedad/{id}/resumen_empleados', 
tags=["Sociedades"],
#dependencies=[Depends(JWTBearer())],
responses=
    { 
...
# ruta para listar los datos historicos de la sociedades por ID
@grupos_empleados_router.get ('/sociedad/{id}/list_historico', 
tags=["Sociedades"],
#dependencies=[Depends(JWTBearer())],
responses=
    { 
...
@grupos_empleados_router.get ('/search_sociedad', 
tags=["Sociedades"],
#dependencies=[Depends(JWTBearer())],
responses=
    { 
...
@grupos_empleados_router.put ('/sociedad/{id}/update', 
tags=["Sociedades"],
#dependencies=[Depends(JWTBearer())],
responses=
    { 
