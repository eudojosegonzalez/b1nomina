...
@basic_parameter_router.post ('/create_basic_parameter', tags=["Parámetros Básicos"],status_code=200, dependencies=[Depends(JWTBearer())])
...
@basic_parameter_router.get ('/basic_parameter', tags=["Parámetros Básicos"],status_code=200, dependencies=[Depends(JWTBearer())])
...
@basic_parameter_router.get ('/basic_parameter/{id}', tags=["Parámetros Básicos"],status_code=200, dependencies=[Depends(JWTBearer())])
...
@basic_parameter_router.put ('/basic_parameter/{id}/update', tags=["Parámetros Básicos"],status_code=200, dependencies=[Depends(JWTBearer())])
