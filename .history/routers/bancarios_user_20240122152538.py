...
async  def get_historico_bancarios_user(userId : int =Path (ge=1,le=os.getenv("MAX_ID_USERS")))->dict:
    db = Session()
    # almacenamos el listado de usarios en un resultset
    result = bancariosUserController(db).list_bancarios_users(userId)
