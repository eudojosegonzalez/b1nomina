...
@user_contact_router.post ('/create_user_contact', tags=["Instituciones AFP"],status_code=200, dependencies=[Depends(JWTBearer())])
...
@user_contact_router.get ('/user_contact', tags=["Instituciones AFP"],status_code=200, dependencies=[Depends(JWTBearer())])
...
@user_contact_router.get ('/user_contact/{id}', tags=["Instituciones AFP"],status_code=200, dependencies=[Depends(JWTBearer())])
...
@user_contact_router.put ('/user_contact/{id}/update', tags=["Instituciones AFP"],status_code=200, dependencies=[Depends(JWTBearer())])
