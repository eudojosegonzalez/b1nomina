...
def list_user_contact(userUpdaterId:int,contactUserSchema:ContactUserSchema)->dict:
    db = Session()
    ...
    if (estado=="1") :
        ...
        return JSONResponse (status_code=500,content={"message":"No se conssiguieron los datos de contacto del usuario","estado":result})      
