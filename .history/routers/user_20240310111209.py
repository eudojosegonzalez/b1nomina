...
# Funcion para crear los datos personles de un usuario
@user_router.post ('/user/{id}/save_preuser',
tags=['Usuarios'],
#dependencies=[Depends(JWTBearer())], 
responses=
    { 
...
def save_preuser(preregistro_user2:PreUser2Schema, id : int = Path (e=1, le=os.getenv("MAX_ID_USERS")))->dict:
    db = Session()
    result=userController(db).update_pre_user(preregistro_user2,id)
    # evaluamos el resultado
    estado=result['result']
