...
def create_banco():
    return JSONResponse (status_code=201,content={"message":" Obtener un listado de los Bancos en el sistema"})  
...
def list_bancos():
    return JSONResponse (status_code=200,content={"message":" Obtener un listado de los Bancos en el sistema"})  
