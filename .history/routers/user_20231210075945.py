    ...
    if (userVerified):
        ...
        if (autorized):
            ...
            if (userActive):
                ...
                userDict={"username":username,"password":password,"exp":14400}
                ...
                return JSONResponse (status_code=202,content={"token":token,"userId":userVerified.id,"exp:":expiration_time})
            else:
                #usuario suspendido
