                    ...
                    "application/json":
                        { 
                            "example":
                                {
                                    "message":"Usuario encontrado",
                                    "data": "{'documento': '1','nombres': 'Admin','apellidos': 'Root','correo': 'null','nacionalidad': '1','genero': '1','fechaNacimiento': '1990-01-01','estadoCivil': '1','region': '13','localidad': '13106','direccion': 'alguna dirección dos','telefonoCelular': 'null','telefonoLocal': 'null','nivelEstudio': 'null'}",
                                }
                        } 
