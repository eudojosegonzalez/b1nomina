...
@basic_parameter_router.post ('/create_basic_parameter', tags=["Parametros Basicos"])
def create_basic_parameter():
    return "Hello word!"


# ruta para listar los Parametros Básicos 
@basic_parameter_router.get ('/basic_parameter', tags=["Parametros Basicos"])
def list_basic_parameters():
    return "Hello word!"


# ruta para consultar un Parametros Básicos por Id
@basic_parameter_router.get ('/basic_parameter/{id}', tags=["Parametros Basicos"])
...
@basic_parameter_router.put ('/basic_parameter/{id}/update', tags=["Parametros Basicos"])
