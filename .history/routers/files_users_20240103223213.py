...
async def file_upload_user(id:int = Path (ge=1, lt=os.getenv("MAX_ID_USERS")),creatorUserId:int = Query (ge=1, lt=os.getenv("MAX_ID_USERS")) ,file: UploadFile=File())->dict:
    db = Session()
