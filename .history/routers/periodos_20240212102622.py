...
@periodos_router.post ('/create_sede', 
tags=["Sedes"],
...
def create_preiodo(periodos:PeriodosSchema, userCreatorId : int = Query (ge=1, le=os.getenv("MAX_ID_USERS")))->dict:
    db = Session()
...
@periodos_router.get ('/list_sede_sociedad', 
tags=["Sedes"],
#dependencies=[Depends(JWTBearer())],
responses=
    { 
...
@periodos_router.get ('/sede/{id}/list_historico', 
tags=["Sedes"],
#dependencies=[Depends(JWTBearer())],
responses=
    { 
...
@periodos_router.get ('/search_sede', 
tags=["Sedes"],
#dependencies=[Depends(JWTBearer())],
responses=
    { 
...
@periodos_router.put ('/sede/{id}/update', 
tags=["Sedes"],
#dependencies=[Depends(JWTBearer())],
responses=
    { 
...
def update_sede(periodos:PeriodosSchema, user_updater: int = Query(ge=1, le=os.getenv('MAX_ID_USERS')), id : int = Path(ge=1,le=1000))->dict:
    db = Session()
