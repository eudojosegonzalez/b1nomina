...
class sociedadesController():
    ...
    def get_parametros_crear_usuario(self, idSociedad):
        ...
        #periodo salario
        tiposSalario=[{"id":"1","valor":"Quincenal"},{"id":"2","valor":"Mensual"},{"id":"3","valor":"A término"}]         
        
        #Termino Contrato
        TerminoContrato=[{"id":"0","valor":"Indefinido"},{"id":"1","valor":"Definido"}]   
        
        #Tipo Contrato
        TipoContrato=[{"id":"1","valor":"Empleado"},{"id":"2","valor":"Pasante"}]           
