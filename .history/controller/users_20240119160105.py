            ...
            if (user):
                ...
                #actualizamos la data personal del usuario
                    ...
                    if (nRecordUsername > 0):
                        ...
                        return ({"result":"-2","estado":"Este Username ya esta siendo ocupado en el sistema","UserId": userId})     
                    elif (nRecordRut > 0):    
                        # se el rut ya esta siendo usado por otra persona
                        return ({"result":"-4","estado":"Este RUT ya esta registrado a nombre de otro usuario","UserId": userId})        
                    elif (nRecordRutProvisorio > 0):    
                        # se el rut ya esta siendo usado por otra persona
                        return ({"result":"-5","estado":"Este RUT Provisorio ya esta registrado a nombre de otro usuario","UserId": userId})                                                            
                    else:
                        user.rut=data.rut
                        user.rut_provisorio=data.rut_provisorio
                        user.apellido_paterno=data.apellido_paterno.upper().strip()
