...
class grupoEmpleadoesController():
    ...
    def get_grupo_empleado(self,id:int):
    ...
    def search_grupo_empleado(self,finding ,page, records):
    ...
    def update_grupo_empleado(self, grupoEmpleado:GruposEmpleadoSchema, userUpdaterId:int, id:int):
        #obtenemos la fecha/hora del servidor
        ahora=datetime.datetime.now()
    ...
    # listar los empleados de un grupo no importa la sociedad
