...
class CategoriasConfigurcionController():
    ...
    def create_historico_categoria_configuracion(self, categoriasConfiguracion: CategoriasConfiguracionModel, observacion:str):
        ...
        try:
            ...
            newHistoricocategoriaConfiguracion= HistoricoCategoriasConfiguracionModel(
                categoria_configuracion_id=categoriasConfiguracion.id,
    ...
    def list_categoria_configuracions(self):
        result = self.db.query(CategoriasConfiguracionModel).all()
        return (result)
    ...
    def list_categoria_configuracions_sociedad(self,idSociedad, page, records):
        consulta = self.db.query(CategoriasConfiguracionModel).filter(CategoriasConfiguracionModel.sociedad_id==idSociedad)
    ...
    def list_history_categoria_configuracions(self, id:int):

        # buscamos si exite la categoria_configuracion
        nRecord = self.db.query(HistoricoCategoriasConfiguracionModel).filter(HistoricoCategoriasConfiguracionModel.sociedad_id == id).count()
        ...
        if (nRecord == 0):
            ...
            try:
                ...
                listHistorycategoria_configuracion = self.db.query(HistoricoCategoriasConfiguracionModel).filter(HistoricoCategoriasConfiguracionModel.sociedad_id == id).all()
