...
class sedesController():
    ...
    def create_historico_cuenta_contable(self, cuentaContable:CuentasContablesModel, observacion:str):
        ...
        try:
            ...
            newHistoricoCuentacontable= HistoricoCuentasContablesModel(
                cuentas_contable_id=cuentaContable.id,
    ...
    def create_cuenta_contable(self, cuentaContable:cuentaContablesSchema, userCreatorId:int ):
        ...
        nombreCuentaContable=cuentaContable.nombre.upper().strip()
        ...
        if (nRecordNombre > 0):
            ...
            cuentaContableExists=self.db.query(CuentasContablesModel).filter(CuentasContablesModel.nombre == nombreSede).first() 
            ...
            try:
                newCuentaContable=CuentasContablesModel(
                    sociedad_id=cuentaContable.sociedad_id,
                    nombre=((cuentaContable.nombre).upper()).strip(),
                    region_id=cuentaContable.region_id,
                    comuna_id=cuentaContable.comuna_id,
                    direccion=((cuentaContable.direccion).upper()).strip(),
                    ciudad=((cuentaContable.ciudad).upper()).strip(),
                    created=ahora,
                    updated=ahora,
                ...
                data={
                    ...
                    "nombre": newCuentaContable.nombre,
                    "region_id":newCuentaContable.region_id,
                    "comuna_id":newCuentaContable.comuna_id,
                    "ciudad":newCuentaContable.ciudad,
                    "direccion":newCuentaContable.direccion,
    ...
    def search_cuenta_contables(self,finding ):
    ...
    def update_cuenta_contable(self, cuentaContable:cuentaContablesSchema, userUpdaterId:int, id:int):
        ...
        if (nRecord == 0):
            ...
            try:
                ...
                cuentaContableExists.nombre=((cuentaContable.nombre).upper()).strip(),
                cuentaContableExists.region_id=cuentaContable.region_id,
                cuentaContableExists.comuna_id=cuentaContable.comuna_id,
                cuentaContableExists.direccion=((cuentaContable.direccion).upper()).strip(),
                cuentaContableExists.ciudad=((cuentaContable.ciudad).upper()).strip(),
                ...
                data={
                    ...
                    "nombre":cuentaContableExists.nombre,
                    "region_id":cuentaContableExists.region_id,
                    "comuna_id":cuentaContableExists.comuna_id,
                    "direccion":cuentaContableExists.direccion,
                    "ciudad":cuentaContableExists.ciudad,
    ...
    def list_cuenta_contables(self, ):
    ...
    # @params page: pagina de los datos que se mostrará
    # @params records: cantidad de registros por página
    def list_cuenta_contables_sociedad(self,idSociedad):
    ...
    def list_history_cuenta_contables(self,  id:int):
