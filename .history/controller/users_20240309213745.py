        ...
        if ((nRecordUserRut > 0 ) or (nRecordUserRutProvisiorio > 0)):
            ...
            try:
                ...
                if (nRecordUbicationUser > 0):
                    ...
                    return( {"result":"1","estado":"Datos Actualizados"})   
            ...
            try:
                ...
                newUser=UsuarioModel(
                    rut = preUser.documento,
                    nombres = preUser.nombres,
                    apellido_paterno  = preUser.apellidos,
                    fecha_nacimiento = datetime.datetime.strptime(preUser.fechaNacimiento,"%Y-%m-%d"),
                ...
                return( {"result":"1","estado":"Datos Creados"})  
                    ...
                    if ((row[0] is not None) and (len(row[0].strip())>0)):  
                        ...
                        if (allOk):                    
                            Persona=UserMassiveSchema(rut=rutv,
                                                    ...
                                                    fecha_nacimiento=datetime.datetime.strftime(fechaNacimiento, "%d/%m/%Y"),
                                                    sexo_id=sexoT,
                            ...
                            if (result['result']=="1"):
                                ...
                                datosLaborales=DatosLaboralesSchema(
                                    ...
                                    termino_contrato=1,
                                    fecha_inicio= datetime.datetime.strftime(fechaInicio, "%d/%m/%Y"),
