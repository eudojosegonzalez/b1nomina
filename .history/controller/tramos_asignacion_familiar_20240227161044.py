...
class TramosImpuestoUnicoController():
    ...
    def create_historico_tramo_aisgnacion_familiar(self, tramosAsignacionFamiliar: TramosAsignacionFamiliarModel, observacion:str):
    ...
    def create_tramo_aisgnacion_familiar(self, tramoasignacionfamiliar:TramosAsignacionFamiliar, userCreatorId:int ):
        ...
        if (nRecordNombre > 0):
            ...
            try:
                newTramoImpuestoUnico=TramosAsignacionFamiliarModel(
                    ...
                    factor=tramoAsignacionFamiliar.factor,                    
                    rebaja=tramoAsignacionFamiliar.rebaja,                    
                    created=ahora,
                    updated=ahora,
                ...
                self.create_historico_tramo_aisgnacion_familiar(newTramoImpuestoUnico,"Se creó un tramo de Asignacion Familiar en el sistema")
    ...
    def get_tramo_aisgnacion_familiar(self,id:int):
    ...
    def search_tramo_aisgnacion_familiar(self,finding):
    ...
    def update_tramo_aisgnacion_familiar(self, tramoAsignacionFamiliar:TramosAsignacionFamiliarSchema, userUpdaterId:int, id:int):
        #obtenemos la fecha/hora del servidor
        ahora=datetime.datetime.now()
        ...
        if (nRecord == 0):
            ...
            try:
                ...
                self.create_historico_tramo_aisgnacion_familiar(tramoAsignacionExists ,"Actualización de la data del Tramo de Impueto Único")
    ...
    def list_tramo_aisgnacion_familiar(self):
    ...
    def list_history_tramo_aisgnacion_familiar(self, id:int):
        ...
        if (nRecord == 0):
            ...
            try:
                ...
                return ({"result":"1","estado":"Se consiguieron los datos historicos del tramo de Asignacion Familiar","data": listHistorySede})
            except ValueError as e:
                # ocurrió un error devolvemos el error
                return( {"result":"-1","error": str(e)})     