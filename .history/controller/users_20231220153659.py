...
class userController():
    ...
    def list_users(self,response_model=Page[ViewGeneralUser]):
        result= paginate(self.db, select(ViewGeneralUser).order_by(ViewGeneralUser.id))     
        return add_pagination(result)   
        '''result= self.db.query(ViewGeneralUser).all()
