...
class TramosImpuestoUnicoController():
    ...
    def create_tramo_impuesto_unico(self, tramoImpuestoUnico:TramosImpuestoUnicoSchema, userCreatorId:int ):
        ...
        nombreTramo=tramosImpuesto.nombre.upper().strip()
        ...
        if (nRecordNombre > 0):
            ...
            return ({"result":"-1","estado":"Existe una sede con ese nombre","data":tramoImpuestoExists})          
        else:    
    ...
    def update_tramo_impuesto_unico(self, tramoImpuestoUnico:TramosImpuestoUnicoSchema, userUpdaterId:int, id:int):
        ...
        if (nRecord == 0):
            ...
            try:
                ...
                self.create_historico_tramo_impuesto_unico(tramoImpuestoExists ,"Actualización de la data de la sede")
                ...
                return ({"result":"1","estado":"Se actualizó el dato del tramo de impuesto","data":data})
            except ValueError as e:
                return( {"result":"-3","error": str(e)})                    
    ...
    def list_tramo_impuesto_unicos(self):
    ...
    def list_history_tramo_impuesto_unicos(self, id:int):
