    ...
    def create_campos_adicionales_user(self, camposUser: CamposAdicionalesUserSchema, userCreatorId:int ):
        ...
        if (nRecordNombre > 0):
            ...
            try:
                ...
                CamposUserController.create_historico_campos_adicionales_user(newSCamposAdicionalesUser,"Se creó una configuracion de campos adicionales en el sistema")
    ...
    def update_campos_adicionales_user(self, camposUser: CamposAdicionalesUserSchema, userUpdaterId:int, id:int):
        ...
        if (nRecord == 0):
            ...
            try:
                ...
                CamposUserController.create_historico_campos_adicionales_user(camposUserExists ,"Actualización de la data de Campos Adicionales del Usuario")
