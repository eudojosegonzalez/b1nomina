...
from models.view_general_bancarios_user import ViewGeneralBnacariosUser  as ViewGeneralBnacariosUserModel
...
class bancariosUserController():
    ...
    def update_bancario_user(self,userUpdaterId:int ,bancarioUsuario:BancariosUserSchema):
        ...
        if (nRecord == 0):
            ...
            try:
                ...
                if (bancarioUsuario.en_uso==1):
                    enUsoT=True
                else:
                    enUsoT=False

                if (bancarioUsuario.terceros==1):
                    tercerosT=True
                else:
                    tercerosT=False                    
                ...
                bancarioUserExists.en_uso = enUsoT,
                bancarioUserExists.terceros = tercerosT ,
    ...
    def list_bancarios_users(self, page, records):
        consulta = self.db.query(ViewGeneralBnacariosUserModel)
