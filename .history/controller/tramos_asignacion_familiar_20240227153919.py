...
from models.historico_tramo_asignacion_familiar import TramosAsignacionFamiliar as 
...
class TramosImpuestoUnicoController():
    ...
    def create_historico_tramo_aisgnacion_familiar(self, tramosImpuesto: TramosImpuestoUnicoModel, observacion:str):
    ...
    def create_tramo_aisgnacion_familiar(self, tramoImpuestoUnico:TramosImpuestoUnicoSchema, userCreatorId:int ):
        ...
        if (nRecordNombre > 0):
            ...
            try:
                ...
                self.create_historico_tramo_aisgnacion_familiar(newTramoImpuestoUnico,"Se creó un Tramo de Impuesto Único en el sistema")
    ...
    def update_tramo_aisgnacion_familiar(self, tramoImpuestoUnico:TramosImpuestoUnicoSchema, userUpdaterId:int, id:int):
        #obtenemos la fecha/hora del servidor
        ahora=datetime.datetime.now()
        ...
        if (nRecord == 0):
            ...
            try:
                ...
                self.create_historico_tramo_aisgnacion_familiar(tramoImpuestoExists ,"Actualización de la data del Tramo de Impueto Único")
    ...
    def list_history_tramo_aisgnacion_familiar(self, id:int):
        ...
        if (nRecord == 0):
            ...
            try:
                ...
                return ({"result":"1","estado":"Se consiguieron los datos historicos del Tramo de Impuesto Único","data": listHistorySede})
            except ValueError as e:
                # ocurrió un error devolvemos el error
                return( {"result":"-1","error": str(e)})     