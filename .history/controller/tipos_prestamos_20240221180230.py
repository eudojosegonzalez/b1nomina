...
class TiposPrestamosController():
    ...
    def create_historico_tipos_prestamos(self, tiposPrestamos: TiposPrestamosModel, observacion:str):
        ...
        try:
            ...
            newTiposPrestamos= HistoricoTiposPrestamosModel(
                tipos_prtestamos_id=tiposPrestamos.id,
    ...
    def create_tipos_prestamos(self, tiposPrestamos:TiposPrestamosSchema, userCreatorId:int ):
        ...
        if (nRecordNombre > 0):
            ...
            return ({"result":"-1","estado":"Existe una TiposPrestamos con ese nombre","data":TiposPrestamosExists})          
        else:    
    ...
    def search_tipos_prestamoss(self,finding ):
    ...
    def update_tipos_prestamos(self, tiposPrestamos:TiposPrestamosSchema, userUpdaterId:int, id:int):
        ...
        if (nRecord == 0):
            ...
            try:
                ...
                self.create_historico_TiposPrestamos(TiposPrestamosExists ,"Actualización de la data de los Tipos de Prestamos")
    ...
    # @params page: pagina de los datos que se mostrará
    # @params records: cantidad de registros por página
    def list_tipos_Prestamoss_sociedad(self,idSociedad):
    ...
    def list_history_tipos_prestamoss(self, id:int):
        ...
        if (nRecord == 0):
            ...
            try:
                # ejecutamos la consulta
                consulta = self.db.query(HistoricoTiposPrestamosModel).filter(HistoricoTiposPrestamosModel.sociedad_id == id)
