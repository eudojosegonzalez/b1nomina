...
class UnidadesPactoController():
    ...
    def create_unidadPacto(self, unidadPacto:UnidadesPactoSchema, userCreatorId:int ):
        ...
        if (nRecordNombre > 0):
            ...
            return ({"result":"-1","estado":"Existe un banco con ese nombre","data":unidadPactoExists})
    ...
    def update_unidad_pacto(self, unidadPacto:UnidadesPactoSchema, userUpdaterId:int, id:int):
        ...
        if (nRecord == 0):
            ...
            try:
                ...
                unidadPactoExists.estado=unidadPacto.estado,
