...
class AFPController():
    ...
    def create_AFP(self, AFP:AFPSchema, userCreatorId:int ):
        ...
        codigoAFP=AFP.codigo.upper().strip()
        ...
        nRecordCodigo = self.db.query(AFPModel).filter(AFPModel.codigo == codigoAFP).count()  
        ...
        if (nRecordNombre > 0):
            ...
            AFPExists=self.db.query(AFPModel).filter(AFPModel.codigo == codigoAFP).first() 
            ...
            try:
                ...
                data={
                    "id":newAFP.id,
                    "codigo": newAFP.codigo,
                    "nombre": newAFP.nombre,
                    "nomina": newAFP.nomina,
    ...
    def update_AFP(self, AFP:AFPSchema, userUpdaterId:int, id:int):
        ...
        if (nRecord == 0):
            ...
            try:
                ...
                data={
                    "id":AFPExists.id,
                    "codigo":AFPExists.codigo,
                    "nombre":AFPExists.nombre,
                    "nomina":AFPExists.nomina,
    ...
    def list_AFPs(self, page, records):
