...
class contactUserController():
    ...
    # funcion para crear el registro de historico deñ cpmtacto del usuario
    #@param contactUser: Modelo del registro de contaco del usuario
    #@param observavacion: Observación sobre el historico
    def create_historico_bancario_user (self, contactUser: contactUserModel, observacion:str):
    ...
    def create_bancario_user(self, userCreatorId:int ,contactoUsuario:contactUserSchema):
