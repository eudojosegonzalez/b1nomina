...
class userController():
    ...
    def upload_file_user(self,creatorUserId,userId,file):
        ...
        #tamaño de los archivos permitidos en Megabytes (n/1024/1024)
        #este valor esta expresado en Bytes
        permitedSizeFiles =  20971520   
        ...
        file_size = file.size
        if (file_size > permitedSizeFiles):
            # El archivo es demasiado grande
            return ({"result":"-2","estado":f"El archivo es demasiado grande, tamaño máximo permitido {(permitedSizeFiles/1024/1024)}Mb"})
