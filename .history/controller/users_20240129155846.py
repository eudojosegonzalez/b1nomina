...
class userController():
    ...
    def get_user_modules(self, userId):
        ...
        Modulos= dict(list(self.db.query(ModuloModel).all()))

        # buscamos los modulos asociados al usuario
        ModulosUsuario= dict(list(self.db.query(viewGeneralUserModuloModel).filter(viewGeneralUserModuloModel.user_id==userId).all()))
