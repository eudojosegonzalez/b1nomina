...
class userController():
    ...
    def create_user(self, usuario:UserSchema):
        ...
        nRecordUserName = self.db.query(UsuarioModel).filter(UsuarioModel.username == userName).first()   
        nRecordUserRut = self.db.query(UsuarioModel).filter(UsuarioModel.rut == rutV).first()
