...
class CategoriasConfiguracionController():
    ...
    def list_history_categoria_configuracion(self, id:int):
        ...
        nRecord = self.db.query(HistoricoCategoriasConfiguracionModel).filter(HistoricoCategoriasConfiguracionModel.id == id).count()
        ...
        if (nRecord == 0):
            ...
            try:
                ...
                listHistorycategoria_configuracion = self.db.query(HistoricoCategoriasConfiguracionModel).filter(HistoricoCategoriasConfiguracionModel.id == id).all()
