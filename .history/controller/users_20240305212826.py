...
class userController():
    ...
    def upload_massive_user(self,creatorUserId,file):
        #obtenemos la fecha/hora del servidor
        ahora=datetime.datetime.now()
        ...
        if (fileExtension in permitedExtensionMassiveUsers):
            ...
            sheet = workbook.active  # Usar "CargaEmpleados" si la hoja tiene nombre
            
            for row in sheet.iter_rows(min_row=2):  # Omitir primera fila (encabezados)
                ...
                nombresV = row[2].value
                apellidoPaterno = row[3].value
                apellidoMaterno = row[4].value
                region=row[5].value
                comuna=row[6].value
                direccion=row[7].value
                correo = row[8].value
                fechaNacimiento=row[9].value
                estadoCivil=row[10].value
                sexo=row[11].value
                nacionalidad=row[12].value
                telefonoFijo=row[13].value
                celular=row[14].value
                sueldoBase=row[15].value
                UnidadSueldoBase=row[16].value
                JubiladoAFP=row[17].value
                Afiliado_AFC=row[21].value
                Id_Prev_Salud=row[22].value
                Pactado_Salud=row[23].value
                IdTipoContrato=row[24].value
                AsignacionColacion=row[25].value
                AsignacionMovilizacion=row[26].value
                MedioDePago=row[27].value
                IdGrupo=row[28].value
                H_Ingreso=row[29].value
                H_Salida=row[30].value
                Ciudad=row[31].value
                TipoIdentificador=row[32].value
                Observaciones_Generales=row[33].value
                Campo_Usr1=row[34].value
                Campo_Usr2=row[35].value
                Campo_Usr3=row[36].value
                Campo_Usr4=row[37].value
                Campo_Usr5=row[38].value
                CorreoPersonal=row[39].value
                IdDim1=row[40].value
                IdDim2=row[41].value
                IdDim3=row[42].value
                IdDim4=row[43].value
                IdDim5=row[44].value
                IdNivelEstudios=row[45].value
                ...
                result=self.create_user(self,Persona)
                ...
                if (result['result']=="1"):
                    ...
                    return ({"result":"-2","estado":"archivo no _subido"})
                
                else:    
                    # escribimos en el archivo de resultados que ocurrio un problema inexperado
                    return ({"result":"-3","estado":"archivo_subido"})
