...
class mutualesController():
    ...
    def create_mutuales(self, mutual:mutualesSchema, userCreatorId:int ):
        ...
        if (nRecordNombre > 0):
           ...
           mutualExists=self.db.query(mutualesModel).filter(mutualesModel.nombre == nombreBanco).first() 
            ...
            try:
                ...
                self.create_historico_mutuales(newMutual,"Se creó un banco en el sistema")
