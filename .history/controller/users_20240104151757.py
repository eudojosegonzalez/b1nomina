...
class userController():
    ...
    def create_history_user (self,userUpdater: int, user:UsuarioModel, observacion: str):
    ...
    def create_user(self, usuario:UserSchema):
        ...
        try:
            ...
            _self.create_history_user (userUpdater: int, user:UsuarioModel, observacion: str)            
