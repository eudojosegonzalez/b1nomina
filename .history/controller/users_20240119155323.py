        ...
        try:       
            ...
            if (user):
                ...
                #actualizamos la data personal del usuario
                    ...
                    nRecordRut=self.db.query(UsuarioModel).filter(UsuarioModel.rut==data.rut & UsuarioModel.id!=data.id).count() 

                    #veiricamos que ese rut_provisorio no este registrado en el sistema
                    nRecordRutProvisorio=self.db.query(UsuarioModel).filter(UsuarioModel.rut_provisorio==data.rut_provisorio & UsuarioModel.id!=data.id).count()                                       
