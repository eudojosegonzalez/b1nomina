...
class PrevisionSaludController():
    ...
    def search_prevision_saluds(self,finding):
        ...
        if (nRecord == 0):
            ...
            try:
                ...
                data={
                    ...
                    "sede_id":previsionExists.sociedad_id,
                    "nombre":previsionExists.nombre,
                    "region_id":previsionExists.region_id,
                    "comuna_id":previsionExists.comuna_id,
                    "direccion":previsionExists.direccion,
                    "ciudad":previsionExists.ciudad,
