...
class DatosLaboralesController():
    ...
    #metodo para consultar los datos Laborales por id de usuario
    # @param id: Id del usuario que se esta conssuyltado los datos lborales
    def get_datos_laborales_userid(self,id:int):
        ...
        if (nRecord == 0):
            ...
            try:
                DatosLaboralesExits = self.db.query(DatosLaboralesModel).filter(DatosLaboralesModel.user_id == id).first()                  
    ...
    # metodo para consultar todas los Datos Laborales por Id de Sociedad
    # @params id: representa el Id de la Sociedad
