...
class mutualesController():
    ...
    # @params cadena: cadena que se buscara en la tabla mutual comparando con el campo nombre y codigo      
    ...
    def update_mutuales(self, mutual:mutualesSchema, userUpdaterId:int, id:int):
        ...
        if (nRecord == 0):
            ...
            try:
                ...
                mutualExists.codigo=((mutual.codigo).upper()).strip(),
                ...
                data={
                    "id":mutualExists.id,
                    "codigo":mutualExists.codigo,
                    "nombre":mutualExists.nombre,
                    "nomina":mutualExists.nomina,
