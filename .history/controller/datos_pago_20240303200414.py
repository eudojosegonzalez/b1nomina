...
class DatosPagoController():
    ...
    def update_datos_pago(self, datosPago:DatosPagoSchema, userUpdaterId:int, id:int):
        ...
        if (nRecord == 0):
            ...
            try:
                ...
                #creamos el registro historico de datos de pago es
                self.create_historico_datos_pago(datosPagoExists ,"Actualización de lo Datos de Pago")

                #registramnos los cambios en la tabla de datos de pago es
                ...
                data={
                    ...
                    "sociedad_id":datosPagoExists.sociedad_id,
                    "sede_id":datosPagoExists.sede_id,
                    "departamento_id":datosPagoExists.departamento_id,
                    "grupo_id":datosPagoExists.grupo_id,                    
                    "cargo_id":datosPagoExists.cargo_id,                    
                    "user_id":datosPagoExists.user_id,                    
                    "tipo_contrato":datosPagoExists.tipo_contrato,
                    "termino_contrato":datosPagoExists.termino_contrato,
                    "fecha_inicio":datosPagoExists.fecha_inicio,
                    "fecha_fin":datosPagoExists.fecha_fin,
                    "periodo_salario":datosPagoExists.periodo_salario,
                    "modalidad":datosPagoExists.modalidad,
                    "dias_descanso":datosPagoExists.dias_descanso,    
                    "salario_base":datosPagoExists.salario_base,                
    ...
    def list_history_datos_pago(self,  id:int):
        ...
        nRecord = self.db.query(HistoricoDatosPagoModel).filter(HistoricoDatosPagoModel.datos_de pago es_id == id).count()
        ...
        if (nRecord == 0):
            ...
            try:
                ...
                consulta = self.db.query(HistoricoDatosPagoModel).filter(HistoricoDatosPagoModel.datos_de pago es_id == id)
