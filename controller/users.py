                    ...
                    if ((row[0] is not None) and (len(row[0].strip())>0)):  
                        ...
                        if (allOk): 
                            ...
                            if (result['result']=="1"):
                                ...
                                if ((Campo_Usr1!="") or (Campo_Usr2!="") or (Campo_Usr3!="") or (Campo_Usr4!="") or (Campo_Usr5!="") ):
                                ...
                                if (IdGrupo is not None ):    
                                    ...
                                    result7=userController.asignate_user_group(self,usuarioGrupo,creatorUserId)
                                ...
                                result8=UsuariosAFCController.create_usuario_afc(self,afiliadoAFC,creatorUserId)
                                ...
                                if ((JubiladoAFP is not None) and (idAFP is not None)):
                                    ...
                                    result9=UsuariosAFPController.create_usuario_afp(AfiliadoAFP,creatorUserId)
                                else:    
                                    result9 = None
